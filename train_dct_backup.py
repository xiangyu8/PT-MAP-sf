...
if __name__ == '__main__':
    ...
    if params.version =='image':
        params.channels = 3

    params.checkpoint_dir = '%s/checkpoints/%s/%s_%s_%schannels_%sway_%sshot' %(configs.save_dir, params.dataset, params.model, params.method, params.channels, params.test_n_way, params.n_shot)
    if params.train_aug:
...
#        model = BaselineTrain( model_dict[params.model], params.num_classes, loss_type = 'dist') 
    ...
    """
        ...
        if params.version == 'dct':
            model = train_manifold_mixup_dct(base_loader, base_loader_test, model, start_epoch, stop_epoch, params)
        else:
